<template>
    ...
    <div class="div-select-ticket">
        <div class="text-center">
            <span>Todos los sorteos juegan con las últimas cuatro cifras de la loter�a de Boyac�, sin serie</span>
        </div>
        ...
        <div class="d-flex justify-content-center w-100 mb-3">
            <div class="w-70 text-center">
                <label class="poppins-bold fs-random-number" for="">N�MEROS AL AZAR</label>
                <div class="input-group mb-3 input-customer">
                    <input type="text" class="form-control poppins-medium" placeholder="Cantidad de N�meros" aria-label="Cantidad de N�meros" aria-describedby="basic-addon2">
        ...
        <div class="d-flex justify-content-center w-100 mt-5">
            <div class="w-70 text-center">
                <label class="poppins-bold fs-random-number" for="">BUSQUE SU N�MERO</label>
                <div class="input-group mb-3 input-customer">
        ...
        <div class="d-flex justify-content-center w-100 mt-5">
            <div class="w-70 text-center">
                ...
                <div class="input-group mb-3 input-customer">
                    <input type="text" class="form-control poppins-medium text-center" placeholder="N�meros seleccionados" readonly
                    aria-label="N�meros seleccionados" aria-describedby="basic-addon2" style="border-top-right-radius: 12px; border-bottom-right-radius: 12px;">
                </div>
            </div>
        </div>
